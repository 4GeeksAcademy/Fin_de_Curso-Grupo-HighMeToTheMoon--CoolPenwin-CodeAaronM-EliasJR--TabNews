// src/front/js/pages/EditNewspaper.js
...
export const EditNewspaper = () => {
    ...
    useEffect(() => {
        const newspaper = store.categories.find(cat => cat.id === parseInt(id));
        if (newspaper) {
            setFormData({
                name: newspaper.name,
    ...
    const handleSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                await actions.updateNewspaper(id, formData); // Llamamos la acción para actualizar la categoría
    ...
    const handleGoBack = () => {
        navigate("/newspaper"); // Redirige a la vista de categorías
    };
    ...
    return (
        <div className="container mt-4">
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Form.Group controlId="formNewspaperDescription">
